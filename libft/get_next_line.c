...
/*   Updated: 2023/06/28 15:18:05 by tsodre-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * @return The next line read from the file descriptor, or NULL if the end of
 *         the file has been reached or an error occurs.
 *
 * @note The returned line is dynamically allocated and should be freed
 *       after use.
 */
